...
y=0
twitter.forEach(tweet => {
		  if (tweet.toLowerCase().match(/aude/)) {
		  	y+=1;
			}
});
console.log(y);
...
console.log((twitter.join("").match(/_/g)).length);
...
console.log(twitter.sort(function(a, b){return a.length -b.length}).slice(0,50));



//Quelle est la position dans l'array de la personne @epenser ?
console.log("Quelle est la position dans l'array de la personne @epenser ?");
console.log(twitter.indexOf('@epenser'));
